...
public class CollisionObjectWrapper extends BulletBase {
  ...
  public CollisionObjectWrapper(btCollisionObjectWrapper parent, btCollisionShape shape, btCollisionObject collisionObject, Matrix4 worldTransform, btVoxelInfo voxelInfo, int partId, int index) {
  ...
  public CollisionObjectWrapper(btCollisionObjectWrapper parent, btCollisionShape shape, btCollisionObject collisionObject, Matrix4 worldTransform, btVoxelInfo voxelInfo, int partId) {
  ...
  public CollisionObjectWrapper(btCollisionObjectWrapper parent, btCollisionShape shape, btCollisionObject collisionObject, Matrix4 worldTransform, btVoxelInfo voxelInfo) {
  ...
  public CollisionObjectWrapper(btCollisionShape shape, btCollisionObject collisionObject, Matrix4 worldTransform, btVoxelInfo voxelInfo, int partId, int index) {
  ...
  public CollisionObjectWrapper(btCollisionShape shape, btCollisionObject collisionObject, Matrix4 worldTransform, btVoxelInfo voxelInfo, int partId) {
  ...
  public CollisionObjectWrapper(btCollisionShape shape, btCollisionObject collisionObject, Matrix4 worldTransform, btVoxelInfo voxelInfo) {
